...
public class LogViewComponent extends CustomComponent {
	...
	private final Preferences globalPrefs = Preferences.userNodeForPackage(LogViewTabComponent.class);
	private final Preferences tabPrefs = globalPrefs.node("tabs");
